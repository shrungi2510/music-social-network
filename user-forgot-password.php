...
$newpassword=md5($_POST['newpassword']);
  $sql ="SELECT EmailId FROM users_tbl WHERE EmailId=:email and MobileNumber=:mobile";
...
if($query -> rowCount() > 0)
{
$con="update users_tbl set Password=:newpassword where EmailId=:email and MobileNumber=:mobile";
...
<head>
    ...
    <title>Music Network | Password Recovery </title>
