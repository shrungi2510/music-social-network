...
$bookid=$_GET['ISRCcode'];
$studentid=$_GET['UserID'];
$sql="DELETE FROM reqsubscription_tbl WHERE UserID=:studentid and ISRCcode=:bookid";
$query = $dbh->prepare($sql);
$query -> bindParam(':studentid',$studentid, PDO::PARAM_STR);
$query -> bindParam(':bookid',$bookid, PDO::PARAM_STR);
$query->execute();

$sql="update songs_tbl set SubscribersCount=SubscribersCount+1 where ISRCcode=:bookid";
$query = $dbh->prepare($sql);
$query->bindParam(':bookid',$bookid,PDO::PARAM_STR);
$query->execute();
...
<head>
    ...
    <title>Music Network | Issue a new Book</title>
