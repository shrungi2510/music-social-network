...
if (strlen($_SESSION['login']) == 0) {
  header('location:index.php');
    ...
    $_SESSION["uname"] = $results[0]->fname . " " . $results[0]->lname;
    ?>
<!DOCTYPE html>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                            ...
                                            <tbody>
                                                ...
                                                $query->execute();
                                                $results = $query->fetchAll(PDO::FETCH_OBJ);
                                                $sname = $results[0]->fname . " " . $results[0]->lname;
                                                        ...
                                                        <tr class="odd gradeX">
                                                            ...
                                                            if ($qesult[0]->relationship == "") {?>
                                                                ...
                                                                <?php } else {
                                                                    ...
                                                                    $_SESSION["user2"] = $sid;
                                                                    ?>
                                                                <a href="chat.php?user2=<?php echo $sid; ?>&user1=<?php echo $result->id; ?>&sender=<?php echo $sid; ?>&sname=<?php echo $sname; ?>"><button class="btn btn-primary" name="submit" id="submit" type="submit"><i class="fa fa-edit "></i> Chat</button><?php
                                                            }}
                                                            ?>
