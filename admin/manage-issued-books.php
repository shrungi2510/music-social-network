...
<head>
    ...
    <title>Music Network | Manage Subcription</title>
...
{               ?>                                      
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><?php echo htmlentities($result->ISRCcode);?></td>
                                            <td class="center"><?php echo htmlentities($result->SubscriptionDate);?></td>
                                            <td class="center"><?php if($result->SubscriptionCancelDate=="")
                                            {
												$date=Date('Y/m/d');
                                                ...
                                                echo htmlentities("Subscription Live ");?><span style="float:right"><b><?php echo htmlentities($str);?></b></span>
											<?php	
                                            } else {
                                            ...
                                            <a href="update-issue-bookdeails.php?rid=<?php echo htmlentities($result->rid);?>&ISRCcode=<?php echo htmlentities($result->ISRCcode);?>&status=<?php echo htmlentities($str);?>&days=<?php echo htmlentities($days);?>"><button class="btn btn-primary"><i class="fa fa-edit "></i> Edit</button> 
